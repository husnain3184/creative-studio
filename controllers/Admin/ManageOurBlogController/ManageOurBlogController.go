package ManageOurBlogController
...
var blogsModel = models.NewBlogs()
...
func Index(w http.ResponseWriter, r *http.Request) {
	...
	temp, _ := template.ParseFiles("views/backend/OurBlogs/index.html", "views/backend/Dashboard/dashboardlayout.html")
	temp.Execute(w, data)
...
func GetData() string {
	...
	}).ParseFiles("views/backend/OurBlogs/data.html")

	var blogs []entities.Blogs
	err := blogsModel.FindAll(&blogs)
	if err != nil {
...
func GetForm(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		data = map[string]interface{}{
			"title": "Add blogs Data",
		}
	} else {

		var blogs entities.Blogs
		err := blogsModel.Find(id, &blogs)
		if err != nil {

			panic(err)
		}
		data = map[string]interface{}{
			"title": "Edit blogs Data",
			"blogs": blogs,
		}
	}
	temp, _ := template.ParseFiles("views/backend/OurBlogs/form.html")
	temp.Execute(w, data)
...
func Store(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodPost {
		...
		var blogs entities.Blogs
		blogs.Title = r.Form.Get("title")
		blogs.Detail = r.Form.Get("detail")
